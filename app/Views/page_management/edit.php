...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('page-management/update/' . $page['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="form-note">Order in menu (lower numbers appear first)</div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-note">Display this page in the site navigation menu</div>
            </div>

            <div class="form-group">
                <label for="excerpt">Excerpt</label>
                <textarea id="excerpt" name="excerpt" style="min-height: 100px;"><?= old('excerpt', $page['excerpt']) ?></textarea>
                <div class="form-note">Short summary of the page (optional)</div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-note">Upload new image to replace current. Max file size: 2MB. Formats: JPG, PNG, GIF, WebP</div>
                
                <?php if (!empty($page['featured_image'])): ?>
                    <img src="<?= base_url($page['featured_image']) ?>" alt="Current featured image" class="current-image">
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="meta_title" name="meta_title" value="<?= old('meta_title', $page['meta_title']) ?>" maxlength="60">
                <div class="form-note">Recommended: 50-60 characters. Leave empty to use page title.</div>
            </div>

            <div class="form-group">
                <label for="meta_description">Meta Description</label>
                <textarea id="meta_description" name="meta_description" style="min-height: 80px;" maxlength="160"><?= old('meta_description', $page['meta_description']) ?></textarea>
            ...
            <div class="form-actions">
                ...
                <a href="<?= base_url('page-management') ?>" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
