...
<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('post-management/update/' . $post['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="form-group">
                ...
                <textarea id="excerpt" name="excerpt" style="min-height: 100px;"><?= old('excerpt', $post['excerpt']) ?></textarea>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($post['featured_image'])): ?>
                    <img src="<?= base_url($post['featured_image']) ?>" alt="Current featured image" class="current-image">
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="meta_description" name="meta_description" style="min-height: 80px;" maxlength="160"><?= old('meta_description', $post['meta_description']) ?></textarea>
